...
with(this){return _c('p',[_v("(For all use cases below, the "),_c('strong',[_v("System")]),_v(" is the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("WeddingHero")]),_v(" and the "),_c('strong',[_v("Actor")]),_v(" is the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("user")]),_v(", unless specified otherwise)")])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_v("User wants to create a new wedding.")]),_v(" "),_c('li',[_v("User enters the wedding name using the command, e.g., "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("createWedding John & Jane Wedding")]),_v(".")]),_v(" "),_c('li',[_v("WeddingHero validates the input details.")]),_v(" "),_c('li',[_v("WeddingHero creates a new wedding entry in the system.")]),_v(" "),_c('li',[_v("WeddingHero confirms the successful creation of the wedding.\nUse case ends.")])])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_v("At least one wedding has been created in WeddingHero.")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_v("User wants to set a wedding as active.")]),_v(" "),_c('li',[_v("User enters the command "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("setWedding Jack and Jill's wedding")]),_v(" with the desired wedding's name.")]),_v(" "),_c('li',[_v("WeddingHero verifies that the specified wedding exists.")]),_v(" "),_c('li',[_v("WeddingHero sets the wedding as the active wedding.")]),_v(" "),_c('li',[_v("WeddingHero displays a confirmation message that the wedding is now active.\nUse case ends.")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions:")])])}
},function anonymous(
) {
with(this){return _c('p',[_v("2a. "),_c('strong',[_v("Missing Wedding Name")]),_c('br'),_v("\n2a1. If the user issues the command without providing a wedding name, WeddingHero displays an error message indicating that the wedding name is required."),_c('br'),_v("\n2a2. WeddingHero prompts the user to re-enter the command with the correct format."),_c('br'),_v("\n2a3. Upon receiving the correct input, the process resumes at step 3.")])}
},function anonymous(
) {
with(this){return _c('p',[_v("2b. "),_c('strong',[_v("Non-Existent Wedding")]),_c('br'),_v("\n2b1. If the specified wedding name does not match any existing wedding, WeddingHero informs the user that no such wedding was found."),_c('br'),_v("\n2b2. WeddingHero prompts the user to either re-enter a valid wedding name or cancel the operation."),_c('br'),_v("\n2b3. If the user provides a valid wedding name, the process resumes at step 3; if the user cancels, the use case ends.")])}
},function anonymous(
) {
with(this){return _c('p',[_v("2c. "),_c('strong',[_v("Invalid Input Format")]),_c('br'),_v("\n2c1. If the user enters invalid text or an unsupported format for the wedding name, WeddingHero displays an error message indicating the input is invalid."),_c('br'),_v("\n2c2. WeddingHero prompts the user to re-enter the command in the correct format."),_c('br'),_v("\n2c3. Once valid input is provided, the process resumes at step 3.")])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_v("A wedding has been created.")]),_v(" "),_c('li',[_v("A wedding has been set as the active wedding in WeddingHero.")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_v("User wants to view the wedding overview.")]),_v(" "),_c('li',[_v("WeddingHero retrieves the overview details of the current active wedding, including the number of tables, guests\nand list of guests.")]),_v(" "),_c('li',[_v("WeddingHero displays the wedding overview information.")]),_v(" "),_c('li',[_v("Use case ends.")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions:")])])}
},function anonymous(
) {
with(this){return _c('p',[_v("2a. "),_c('strong',[_v("No Active Wedding Set")]),_c('br'),_v("\n2a1. If no active wedding is set, WeddingHero informs the user that an active wedding must be set before viewing an overview."),_c('br'),_v("\n2a2. WeddingHero prompts the user to set a wedding."),_c('br'),_v("\n2a3. Once an active wedding is set, the user may reissue the wedding overview command, and the process resumes at\nstep 2.")])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_v("User decides to add a new guest.")]),_v(" "),_c('li',[_v("User to enters the guest details in the following correct format:"),_c('br'),_v(" "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("addGuest n/john Doe p/81231234 e/JohnDoe@gmail.com a/123 Kent Ridge d/None r/YES")])]),_v(" "),_c('li',[_v("WeddingHero validates the entered details.")]),_v(" "),_c('li',[_v("WeddingHero adds the guest to the current wedding's guest list.")]),_v(" "),_c('li',[_v("WeddingHero displays a confirmation message that the guest has been successfully added.\nUse case ends.")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions:")])])}
},function anonymous(
) {
with(this){return _c('p',[_v("2a. "),_c('strong',[_v("Missing Required Tag")]),_c('br'),_v("\n2a1. If the user omits one or more required identifier tags (e.g. "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("n/")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("p/")]),_v(", etc.)."),_c('br'),_v("\n2a2. WeddingHero displays an error message displaying the correct format, along with an example."),_c('br'),_v("\n2a3. Upon receiving the correct input, the process resumes at step 3.")])}
},function anonymous(
) {
with(this){return _c('p',[_v("2b. "),_c('strong',[_v("Invalid Phone number")]),_c('br'),_v("\n2b1. If the user enters an invalid phone number containing non numbers (e.g. 8124123A)."),_c('br'),_v("\n2b2. WeddingHero displays an error message, informing user that numbers are only allowed for phone number."),_c('br'),_v("\n2b3. Once valid input is provided, the process resumes at step 3.")])}
},function anonymous(
) {
with(this){return _c('p',[_v("2b. "),_c('strong',[_v("Invalid Email address")]),_c('br'),_v("\n2c1. If the user enters an invalid email address (e.g. joe@)."),_c('br'),_v("\n2c2. WeddingHero displays an error message, informing user the requirements for a valid email address."),_c('br'),_v("\n2c3. Once valid input is provided, the process resumes at step 3.")])}
},function anonymous(
) {
with(this){return _c('p',[_v("3c. "),_c('strong',[_v("Duplicate Guest")]),_c('br'),_v("\n3c1. If WeddingHero detects that a guest with the same identifier (e.g. same name) already exists,\nit notifies the user of the duplicate."),_c('br'),_v("\n3c2. WeddingHero prompts the user that guest has already been added."),_c('br'),_v("\nUse case ends.")])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_v("User requests to view the current guest list.")]),_v(" "),_c('li',[_v("WeddingHero displays the list of guests.")]),_v(" "),_c('li',[_v("User selects a guest to delete by providing an identifier (guest name), e.g., "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("deleteGuest n/John Doe")]),_v(".")]),_v(" "),_c('li',[_v("WeddingHero searches for a guest matching the provided name or phone number.")]),_v(" "),_c('li',[_v("WeddingHero deletes the guest.\nUse case ends.")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions:")])])}
},function anonymous(
) {
with(this){return _c('p',[_v("3a. "),_c('strong',[_v("Alternative Identifier: Phone Number")]),_c('br'),_v("\n3a1. Instead of using the guest name, the user issues the delete command with a phone number identifier (e.g., "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("deleteGuest p/81231234")]),_v(")."),_c('br'),_v("\n3a2. WeddingHero searches for a guest matching the provided phone number."),_c('br'),_v("\n3a3. WeddingHero then proceeds to step 5 of the MSS.")])}
},function anonymous(
) {
with(this){return _c('p',[_v("3b. "),_c('strong',[_v("Missing Identifier Tag")]),_c('br'),_v("\n3b1. The user issues the delete command without using the required identifier tag (e.g., "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("deleteGuest John Doe")]),_v(" without "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("n/")]),_v(" or "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("p/")]),_v(")."),_c('br'),_v("\n3b2. WeddingHero detects the missing tag and displays an error message instructing the user to use the correct identifier format."),_c('br'),_v("\n3b3. WeddingHero prompts the user to re-enter the command with either of the proper tags."),_c('br'),_v("\n3b4. If the user re-enters the command with a valid identifier, the process resumes at step 4.")])}
},function anonymous(
) {
with(this){return _c('p',[_v("3c. "),_c('strong',[_v("Invalid Input Text")]),_c('br'),_v("\n3c1. The user enters invalid text that does not conform to the expected format (e.g., contains non-alphanumeric characters)."),_c('br'),_v("\n3c2. WeddingHero identifies the invalid input and displays an error message indicating that the input is invalid."),_c('br'),_v("\n3c3. WeddingHero prompts the user to re-enter a valid identifier."),_c('br'),_v("\n3c4. If the user provides a valid input, the process resumes at step 4.")])}
},function anonymous(
) {
with(this){return _c('p',[_v("5a. "),_c('strong',[_v("No Matching Guest Found")]),_c('br'),_v("\n5a1. WeddingHero is unable to find any guest matching the provided identifier (name or phone number)."),_c('br'),_v("\n5a2. WeddingHero informs the user that no matching guest was found."),_c('br'),_v("\n5a3. If the user re-enters a valid tag with a different value as an identifier, the process resumes at step 4."),_c('br'),_v("\n5a4. If the user changes commands, the use case ends.")])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_v("User decides to add a new table.")]),_v(" "),_c('li',[_v("User enters the command "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("addTable tableID/4 8")]),_v(" with the desired table's ID and capacity.")]),_v(" "),_c('li',[_v("WeddingHero validates that the table ID is unique and that the capacity is a valid positive integer.")]),_v(" "),_c('li',[_v("WeddingHero adds the table to the current wedding selected by "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("setWedding")]),_v(".")]),_v(" "),_c('li',[_v("WeddingHero displays a confirmation message indicating that the table has been successfully added.")]),_v(" "),_c('li',[_v("Use case ends.")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions:")])])}
},function anonymous(
) {
with(this){return _c('p',[_v("2a. "),_c('strong',[_v("Missing Required Details")]),_c('br'),_v("\n2a1. If the user omits the table ID or capacity, WeddingHero displays an error message indicating that both parameters are required."),_c('br'),_v("\n2a2. WeddingHero prompts the user to re-enter the command with the correct format."),_c('br'),_v("\n2a3. Once the correct input is provided, the process resumes at step 3.")])}
},function anonymous(
) {
with(this){return _c('p',[_v("2b. "),_c('strong',[_v("Invalid Capacity")]),_c('br'),_v("\n2b1. If the user enters an invalid capacity (e.g. a non-numeric value or a negative number), WeddingHero displays an error message specifying that the capacity must be a positive integer."),_c('br'),_v("\n2b2. WeddingHero prompts the user to re-enter the command with a valid capacity (e.g. positive numeric number)."),_c('br'),_v("\n2b3. Once a valid capacity is provided, the process resumes at step 3.")])}
},function anonymous(
) {
with(this){return _c('p',[_v("2c. "),_c('strong',[_v("Duplicate Table ID")]),_c('br'),_v("\n2c1. If a table with the provided table ID already exists in the current wedding layout, WeddingHero notifies the user of the duplicate."),_c('br'),_v("\n2c2. WeddingHero prompts the user to enter a new unique table ID."),_c('br'),_v("\n2c3. If a new, unique table ID is provided, the process resumes at step 3; if the user cancels, the use case ends.")])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_v("User decides to delete an existing table.")]),_v(" "),_c('li',[_v("User enters the command "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("deleteTable tableID/3")]),_v(" with the desired table's ID.")]),_v(" "),_c('li',[_v("WeddingHero validates that the table ID is provided.")]),_v(" "),_c('li',[_v("WeddingHero searches for the table matching the provided ID.")]),_v(" "),_c('li',[_v("If a matching table is found, WeddingHero prompts the user to confirm the deletion.")]),_v(" "),_c('li',[_v("User confirms the deletion.")]),_v(" "),_c('li',[_v("WeddingHero deletes the table from the wedding layout.")]),_v(" "),_c('li',[_v("WeddingHero displays a confirmation message that the table has been successfully deleted.\nUse case ends.")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions:")])])}
},function anonymous(
) {
with(this){return _c('p',[_v("2a. "),_c('strong',[_v("Missing Table ID")]),_c('br'),_v("\n2a1. If the user omits the table ID when entering the command, WeddingHero displays an error message indicating that the table ID is required."),_c('br'),_v("\n2a2. WeddingHero prompts the user to re-enter the command with the correct format."),_c('br'),_v("\n2a3. Once the correct input is provided, the process resumes at step 3.")])}
},function anonymous(
) {
with(this){return _c('p',[_v("2b. "),_c('strong',[_v("Table Not Found")]),_c('br'),_v("\n2b1. If WeddingHero is unable to locate a table matching the provided ID, it informs the user that no matching table was found."),_c('br'),_v("\n2b2. WeddingHero prompts the user to either re-enter a valid table ID."),_c('br'),_v("\n2b3. If the user provides a valid table ID, the process resumes at step 3. Otherwise, use case ends.")])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("Initial launch")]),_v(" "),_c('ol',[_c('li',[_v("Download the jar file and copy it into an empty folder.")]),_v(" "),_c('li',[_v("Double-click the jar file."),_c('br'),_v("\nExpected: Shows the GUI with a set of sample contacts. The window size may not be optimum.")])])]),_v(" "),_c('li',[_c('p',[_v("Saving window preferences")]),_v(" "),_c('ol',[_c('li',[_v("Resize the window to an optimum size. Move the window to a different location. Close the window.")]),_v(" "),_c('li',[_v("Re-launch the app by double-clicking the jar file."),_c('br'),_v("\nExpected: The most recent window size and location is retained.")])])]),_v(" "),_c('li',[_c('p',[_c('em',[_v("{ more test cases … }")])])])])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.6.0")]),_v(", generated on Thu, 20 Mar 2025, 22:35:25 GMT+8]")])])])}
}];
