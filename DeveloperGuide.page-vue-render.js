...
with(this){return _c('p',[_v("The "),_c('strong',[_v("API")]),_v(" of this component is specified in "),_c('a',{attrs:{"href":"https://github.com/AY2425S2-CS2103T-F12-3/tp/tree/master/src/main/java/seedu/address/ui/Ui.java"}},[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Ui.java")])])])}
},function anonymous(
) {
...
with(this){return _c('p',[_c('strong',[_v("API")]),_v(": "),_c('a',{attrs:{"href":"https://github.com/AY2425S2-CS2103T-F12-3/tp/tree/master/src/main/java/seedu/address/logic/Logic.java"}},[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Logic.java")])])])}
},function anonymous(
) {
...
with(this){return _c('p',[_c('strong',[_v("API")]),_v(": "),_c('a',{attrs:{"href":"https://github.com/AY2425S2-CS2103T-F12-3/tp/tree/master/src/main/java/seedu/address/model/Model.java"}},[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model.java")])])])}
},function anonymous(
) {
...
with(this){return _c('p',[_c('strong',[_v("API")]),_v(": "),_c('a',{attrs:{"href":"https://github.com/AY2425S2-CS2103T-F12-3/tp/tree/master/src/main/java/seedu/address/storage/Storage.java"}},[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Storage.java")])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_v("The command receives input with the table ID (tid/) and capacity (c/) specified")]),_v(" "),_c('li',[_v("A "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Table")]),_v(" object is created using these values")]),_v(" "),_c('li',[_v("It then attempts to add the table to the current wedding through the model")]),_v(" "),_c('li',[_v("The implementation performs several validation checks:\n"),_c('ul',[_c('li',[_v("Verifies that a current wedding is set (throws "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("NoCurrentWeddingException")]),_v(" if not)")]),_v(" "),_c('li',[_v("Checks if a table with the same ID already exists (throws "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("DuplicateTableException")]),_v(")")]),_v(" "),_c('li',[_v("Validates the format and constraints of the table ID and capacity (throws "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("IllegalArgumentException")]),_v(" if invalid)")])])]),_v(" "),_c('li',[_v("If successful, it returns a success message with the table’s details")]),_v(" "),_c('li',[_v("If any exception is caught, appropriate error messages are shown to the user")])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_v("The command receives the table ID as input, either prefixed (tid/) or raw format")]),_v(" "),_c('li',[_v("It validates the format and value of the table ID")]),_v(" "),_c('li',[_v("The system checks if there is a current wedding set (throws "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("NoCurrentWeddingException")]),_v(" if not)")]),_v(" "),_c('li',[_v("It attempts to remove the table with the specified ID from the current wedding")]),_v(" "),_c('li',[_v("If the table does not exist, a "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("TableNotFoundException")]),_v(" is thrown")]),_v(" "),_c('li',[_v("On success, a confirmation message is returned to the user with the removed table’s details")])])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("findTable")]),_v(" command allows users to look up the details of a specific table in the currently active wedding using its table ID.")])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_v("The command accepts a table ID prefixed with "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("tid/")])]),_v(" "),_c('li',[_v("It validates that a current wedding is set (throws "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("NoCurrentWeddingException")]),_v(" if not)")]),_v(" "),_c('li',[_v("The system searches for a table with the given ID")]),_v(" "),_c('li',[_v("If the table is not found, a "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("TableNotFoundException")]),_v(" is thrown")]),_v(" "),_c('li',[_v("If successful, it displays the table’s details, including:\n"),_c('ul',[_c('li',[_v("Table ID")]),_v(" "),_c('li',[_v("Capacity")]),_v(" "),_c('li',[_v("Number of guests assigned")])])])])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("getTables")]),_v(" command allows users to retrieve and view all tables in the currently active wedding.")])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_v("The command is invoked without any arguments")]),_v(" "),_c('li',[_v("It checks that a current wedding is set (throws "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("NoCurrentWeddingException")]),_v(" if not)")]),_v(" "),_c('li',[_v("It fetches the complete list of tables from the wedding")]),_v(" "),_c('li',[_v("For each table, the following details are displayed:\n"),_c('ul',[_c('li',[_v("Table ID")]),_v(" "),_c('li',[_v("Capacity")]),_v(" "),_c('li',[_v("Number of guests currently assigned")]),_v(" "),_c('li',[_v("Names of assigned guests, if any")])])])])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.6.0")]),_v(", generated on Tue, 8 Apr 2025, 12:27:10 GMT+8]")])])])}
}];
