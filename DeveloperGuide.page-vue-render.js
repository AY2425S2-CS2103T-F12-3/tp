...
with(this){return _c('p',[_v("3a. "),_c('strong',[_v("Alternative Identifier: Phone Number")]),_v("\n3a1. Instead of using the guest name, the user issues the delete command with a phone number identifier (e.g., "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("deleteGuest p/81231234")]),_v(").\n3a2. WeddingHero searches for a guest matching the provided phone number.\n3a3. WeddingHero then proceeds to step 5 of the MSS.")])}
},function anonymous(
) {
with(this){return _c('p',[_v("3b. "),_c('strong',[_v("Missing Identifier Tag")]),_v("\n3b1. The user issues the delete command without using the required identifier tag (e.g., "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("deleteGuest John Doe")]),_v(" without "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("n/")]),_v(" or "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("p/")]),_v(").\n3b2. WeddingHero detects the missing tag and displays an error message instructing the user to use the correct identifier format.\n3b3. WeddingHero prompts the user to re-enter the command with either of the proper tags.\n3b4. If the user re-enters the command with a valid identifier, the process resumes at step 4.")])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.6.0")]),_v(", generated on Mon, 31 Mar 2025, 20:52:25 GMT+8]")])])])}
}];
